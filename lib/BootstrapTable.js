    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(_TableBody2['default'], { ref: 'body', data: this.state.data, columns: columns,
    ...
    value: function renderToolBar() {
      ...
      if (this.props.insertRow || this.props.deleteRow || this.props.search) {
        return _react2['default'].createElement(
          'div',
          { className: 'tool-bar' },
          _react2['default'].createElement(_toolbarToolBar2['default'], { enableInsert: this.props.insertRow,
...
BootstrapTable.propTypes = {
  ...
  options: _react2['default'].PropTypes.shape({
    ...
    isRemoteLoad: _react2['default'].PropTypes.bool,
